// MT25043
//
// File: MT25043_Part_A3_Client.c (ROLE: RECEIVER)
//
// Description: Zero-Copy TCP Client. This client receives data from
...
// - Receiver implementation (simplified from original zero-copy sender)
//
// Student Understanding:
// - Understands zero-copy is sender-side optimization only
// - Can explain why client uses standard recv() (no MSG_ZEROCOPY on receive)
// - Converted from complex zero-copy sender to simple receiver
// - Understands architectural change: servers send, clients receive
// - Ready to explain role reversal and its necessity during viva
// ============================================================================
