// MT25043
//
// File: MT25043_Part_A1_Client.c (ROLE: RECEIVER)
//
// Description: Two-Copy (Baseline) TCP Client. This client receives data from
...
// - Socket connection logic (connect, inet_pton)
// - gettimeofday() timing measurements
// - Atomic operations (__sync_fetch_and_add) for thread-safe aggregation
//
// Prompts Used:
// - "Implement client connection with timing measurements"
// - "Measure throughput and latency per recv operation"
//
// Student Understanding:
// - Understands recv() blocking behavior and buffer management
// - Understands throughput calculation: (bytes * 8) / time / 1e9 for Gbps
// - Understands latency measurement: microseconds per operation
// - Can explain atomic operations for multi-threaded counter aggregation
// - Ready to explain performance metric calculations during viva
// ============================================================================
